      ...
      <div className="mx-auto grid min-h-[calc(100vh-4rem)] w-full max-w-7xl items-center gap-10 px-4 py-12 sm:px-6 lg:grid-cols-[1fr_0.9fr] lg:px-8">
        <div>
          <p className="text-sm font-semibold uppercase text-accent-strong dark:text-accent">
            Version 0.7: build generator workflow
          </p>
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-muted">
            ...
            for used hardware. This version turns the deterministic decision and
            compatibility engines into a complete build recommendation workflow
            using local mock listings only, without live scraping, checkout, or AI.
          </p>
