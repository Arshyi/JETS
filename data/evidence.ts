...
export const evidenceRecords: EvidenceRecord[] = [
  ...
  {
    claim: "ThinkStation P510 is a useful budget engineering workstation base when firmware, storage, and GPU power are reviewed.",
    confidence: "high",
    dateAdded: "2026-07-07",
    extractionMethod: "manual-curation",
    id: "ev-p510-profile-spec",
    platformId: "thinkstation-p510",
    sourceTitle: "JETS curated P510 playbook fixture",
    sourceType: "manual-research",
    sourceUrl: null,
    subjectId: "thinkstation-p510",
    subjectType: "platform-profile",
    supportingText:
      "The playbook treats the P510 as a budget engineering platform with ECC memory, PCIe expansion, and firmware-dependent upgrade caveats.",
    verificationStatus: "verified",
    version: "5.0.0"
  },
  {
    claim: "ThinkStation P510 projects should prioritize PCIe NVMe storage before expensive speculative upgrades.",
    confidence: "high",
    dateAdded: "2026-07-07",
    extractionMethod: "manual-curation",
    id: "ev-p510-nvme-playbook",
    platformId: "thinkstation-p510",
    relatedEvidenceIds: ["ev-adapter-pcie-nvme"],
    sourceTitle: "JETS curated P510 storage playbook",
    sourceType: "manual-research",
    sourceUrl: null,
    subjectId: "p510-nvme",
    subjectType: "upgrade-opportunity",
    supportingText:
      "The deterministic playbook recommends fast PCIe storage as the first practical upgrade when the exact unit supports the path.",
    verificationStatus: "verified",
    version: "5.0.0"
  },
  {
    claim: "Precision T5810 is a value workstation path when the acquisition price leaves room for storage, RAM, and power validation.",
    confidence: "medium",
    dateAdded: "2026-07-07",
    extractionMethod: "manual-curation",
    id: "ev-t5810-profile-spec",
    platformId: "precision-t5810",
    sourceTitle: "JETS curated T5810 playbook fixture",
    sourceType: "manual-research",
    sourceUrl: null,
    subjectId: "precision-t5810",
    subjectType: "platform-profile",
    supportingText:
      "The playbook preserves the T5810 as a budget workstation option with older-platform risk and exact-unit PSU caveats.",
    verificationStatus: "pending-review",
    version: "5.0.0"
  },
  {
    claim: "Precision 5820 is a durable engineering workstation candidate when GPU power, ECC memory, and NVMe storage are balanced.",
    confidence: "high",
    dateAdded: "2026-07-07",
    extractionMethod: "manual-curation",
    id: "ev-5820-profile-spec",
    platformId: "precision-5820",
    sourceTitle: "JETS curated Precision 5820 playbook fixture",
    sourceType: "manual-research",
    sourceUrl: null,
    subjectId: "precision-5820",
    subjectType: "platform-profile",
    supportingText:
      "The playbook models the Precision 5820 as a stronger long-term used workstation base than older budget towers.",
    verificationStatus: "verified",
    version: "5.0.0"
  },
  {
    claim: "HP Z440 can be a low-cost CAD and engineering platform when proprietary PSU and airflow risks are visible.",
    confidence: "medium",
    dateAdded: "2026-07-07",
    extractionMethod: "manual-curation",
    id: "ev-z440-profile-spec",
    platformId: "hp-z440",
    sourceTitle: "JETS curated Z440 playbook fixture",
    sourceType: "manual-research",
    sourceUrl: null,
    subjectId: "hp-z440",
    subjectType: "platform-profile",
    supportingText:
      "The playbook keeps Z440 recommendations conditional on exact PSU, cable, airflow, and chassis review.",
    verificationStatus: "pending-review",
    version: "5.0.0"
  },
  {
    claim: "HP Z440 projects should treat PCIe NVMe storage as a practical value upgrade before larger risky GPU moves.",
    confidence: "medium",
    dateAdded: "2026-07-07",
    extractionMethod: "manual-curation",
    id: "ev-z440-nvme-playbook",
    platformId: "hp-z440",
    relatedEvidenceIds: ["ev-adapter-pcie-nvme"],
    sourceTitle: "JETS curated Z440 storage playbook",
    sourceType: "manual-research",
    sourceUrl: null,
    subjectId: "z440-nvme",
    subjectType: "upgrade-opportunity",
    supportingText:
      "The recommendation is value-focused and remains dependent on exact slot and boot behavior.",
    verificationStatus: "pending-review",
    version: "5.0.0"
  },
  {
    claim: "HP Z840 is best treated as an expansion-heavy lab, storage, or virtualization platform rather than a quiet desktop.",
    confidence: "high",
    dateAdded: "2026-07-07",
    extractionMethod: "manual-curation",
    id: "ev-z840-profile-spec",
    platformId: "hp-z840",
    relatedEvidenceIds: ["ev-z840-sas-hba"],
    sourceTitle: "JETS curated Z840 playbook fixture",
    sourceType: "manual-research",
    sourceUrl: null,
    subjectId: "hp-z840",
    subjectType: "platform-profile",
    supportingText:
      "The playbook emphasizes expansion, SAS/HBA paths, airflow, noise, and power draw as first-order strategy inputs.",
    verificationStatus: "verified",
    version: "5.0.0"
  },
  {
    claim: "Mac Pro 5,1 recommendations should be firmware-aware and treated as repair or specialty modernization paths.",
    confidence: "medium",
    dateAdded: "2026-07-07",
    extractionMethod: "manual-curation",
    id: "ev-macpro-profile-spec",
    platformId: "mac-pro-5-1",
    relatedEvidenceIds: ["ev-macpro-nvme-firmware"],
    sourceTitle: "JETS curated Mac Pro 5,1 playbook fixture",
    sourceType: "manual-research",
    sourceUrl: null,
    subjectId: "mac-pro-5-1",
    subjectType: "platform-profile",
    supportingText:
      "The playbook keeps NVMe and GPU guidance conditional on firmware state and the user's willingness to accept repair complexity.",
    verificationStatus: "pending-review",
    version: "5.0.0"
  },
  {
    claim: "Generic mini PC strategies should be selected for low power, small size, and simplicity rather than expansion.",
    confidence: "medium",
    dateAdded: "2026-07-07",
    extractionMethod: "manual-curation",
    id: "ev-generic-mini-pc-playbook",
    sourceTitle: "JETS curated mini PC playbook fixture",
    sourceType: "manual-research",
    sourceUrl: null,
    subjectId: "generic-mini-pc",
    subjectType: "platform-profile",
    supportingText:
      "The playbook is intentionally generic and warns that GPU, PSU, and motherboard upgrade paths are usually closed.",
    verificationStatus: "pending-review",
    version: "5.0.0"
  },
  {
    claim: "Generic laptop and eGPU strategies need explicit dock, power, bandwidth, monitor, and salvage-risk validation.",
    confidence: "medium",
    dateAdded: "2026-07-07",
    extractionMethod: "manual-curation",
    id: "ev-generic-laptop-playbook",
    sourceTitle: "JETS curated laptop and eGPU playbook fixture",
    sourceType: "manual-research",
    sourceUrl: null,
    subjectId: "generic-laptop",
    subjectType: "platform-profile",
    supportingText:
      "The playbook preserves laptop, eGPU, and laptop-RAM adapter paths as conditional strategies rather than beginner defaults.",
    verificationStatus: "pending-review",
    version: "5.0.0"
  },
  {
